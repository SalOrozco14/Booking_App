...
CREATE TABLE `excursions` (
    ...
    KEY (`vacation_id`),
    CONSTRAINT FOREIGN KEY (`vacation_id`)
        REFERENCES `vacations` (`vacation_id`)
)  ENGINE=INNODB AUTO_INCREMENT=2 DEFAULT CHARSET=UTF8MB4 COLLATE = UTF8MB4_0900_AI_CI;
...
CREATE TABLE `cart_items` (
    ...
    CONSTRAINT FOREIGN KEY (`vacation_id`)
        REFERENCES `vacations` (`vacation_id`),
    CONSTRAINT FOREIGN KEY (`cart_id`)
...
CREATE TABLE `excursion_cartitem` (
    ...
    KEY (`excursion_id`),
    CONSTRAINT FOREIGN KEY (`cart_item_id`)
        REFERENCES `cart_items` (`cart_item_id`),
    CONSTRAINT FOREIGN KEY (`excursion_id`)
